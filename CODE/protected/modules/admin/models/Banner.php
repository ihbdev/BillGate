...
class Banner extends CActiveRecord
{
	...
	const CODE_HOMEPAGE=69;
	const CODE_PRIMARY_SCHOOL_LEFT=70;
	const CODE_PRIMARY_SCHOOL_HEADLINE=71;
	const CODE_PRIMARY_SCHOOL_MIDDLE=72;
	const CODE_HIGH_SCHOOL_LEFT=81;
	const CODE_HIGH_SCHOOL_HEADLINE=82;
	const CODE_HIGH_SCHOOL_MIDDLE=83;
