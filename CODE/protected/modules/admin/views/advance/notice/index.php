	...
	<div class="folder top">
		...
		<div class="folder-header">
			...
			<div class="header-menu">
				<ul>
					<li class="ex-show"><a class="activities-icon" href=""><span>Danh sách thông báo</span></a></li>
				</ul>
			</div>
		</div>
		<!--end title-->
                    ...
                    <ul>
                        <li>
                         ...
                         <?php 
							...
							$list +=Notice::getList_label_specials();
						?>	
						<li>
			...
			$this->widget('iPhoenixGridView', array(
  				...
  				'columns'=>array(
					array(
						...
						'checked'=>'in_array($data->id,Yii::app()->session["checked-notice-list"])'
    				),			
    				array(
						'name'=>'title',
					...
					*/
					...
					array(
    					...
    					(
        					'reverse' => array
    						(
            					'label'=>'Đổi trạng thái thông báo',
            					'imageUrl'=>'$data->imageStatus',
            					'url'=>'Yii::app()->createUrl("admin/notice/reverseStatus", array("id"=>$data->id))',
    							'click'=>'function(){
									var th=this;									
									jQuery.ajax({
										type:"POST",
					...
					array(
						...
						'deleteConfirmation'=>'Bạn muốn xóa thông báo này?',
    					...
    					(
    						...
    						'copy' => array
    						(
            					'label'=>'Copy thông báo',
            					'imageUrl'=>Yii::app()->request->getBaseUrl(true).'/images/admin/copy.gif',
            					'url'=>'Yii::app()->createUrl("admin/notice/copy", array("id"=>$data->id))',
        					),
        					'view'=>array(
    							'url'=>'$data->url',
    						)
