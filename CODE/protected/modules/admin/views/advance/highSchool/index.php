	...
	<div class="folder top">
		...
		<div class="folder-content">
            <div>
            	<input type="button" class="button" value="Thêm tin" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('admin/highSchool/create')?>'"/>
                    ...
                    <ul>
                        <li>
                         ...
                         <?php 
							...
							$list +=HighSchool::getList_label_specials();
						?>	
						<li>
			...
			$this->widget('iPhoenixGridView', array(
  				...
  				'columns'=>array(
					array(
						...
						'checked'=>'in_array($data->id,Yii::app()->session["checked-highSchool-list"])'
    				),			
    				array(
						'name'=>'title',
					...
					array(
    					...
    					(
    						...
    						(
            					...
            					'url'=>'Yii::app()->createUrl("admin/highSchool/reverseStatus", array("id"=>$data->id))',
    							'click'=>'function(){
									var th=this;									
									jQuery.ajax({
										type:"POST",
					...
					array(
    					...
    					(
    						...
    						(
            					...
            					'url'=>'Yii::app()->createUrl("admin/highSchool/copy", array("id"=>$data->id))',
        					),
        					'view'=>array(
    							'url'=>'$data->url',
    						)
