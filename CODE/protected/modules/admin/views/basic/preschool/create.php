<!--begin inside content-->
	<div class="folder top">
		...
		<div>
                <input type="button" class="button" value="Danh sách tin" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('admin/preschool')?>'"/>
				...
				<ul>
					...
					<div id="left_row">
						...
						<li>
                        	...
                        	<?php echo $form->dropDownList($model,'list_special',Preschool::getList_label_specials(),array('style'=>'width:250px','multiple' => 'multiple')); ?>
...
<ul>
		<?php 
			Yii::app()->clientScript->registerScript('search-preschool-suggest', "
	...
	<li>
		...
		<?php echo $form->dropDownList($suggest,'catid',$list,array('style'=>'width:200px','name'=>'SuggestPreschool[catid]')); ?>
	</li>            
	<li>
	<label>&nbsp;</label> 
  		...
  		function(){  	
			...
			jQuery.ajax({
				...
				success:function(data){
					$('#Preschool_list_suggest').val(data);
					hidenPopUp();
				},
				type:'POST',
				url:'<?php echo $this->createUrl('preschool/updateSuggest');?>',
				'cache':'false'});
			return false;
		});
</script>