	...
	<div class="folder top">
		...
		<div class="folder-header">
			<h1>quản trị tuyển sinh</h1>
			<div class="header-menu">
				<ul>
					<li class="ex-show"><a class="activities-icon" href=""><span>Danh sách tin tuyển sinh</span></a></li>
				</ul>
			</div>
		</div>
		<!--end title-->
                    ...
                    <ul>
                        <li>
                         ...
                         <?php 
							...
							$list +=Entrance::getList_label_specials();
						?>	
						<li>
			...
			$this->widget('iPhoenixGridView', array(
  				...
  				'columns'=>array(
					array(
						...
						'checked'=>'in_array($data->id,Yii::app()->session["checked-entrance-list"])'
    				),			
    				array(
						'name'=>'title',
					...
					array(
    					...
    					(
    						...
    						(
            					...
            					'url'=>'Yii::app()->createUrl("admin/entrance/reverseStatus", array("id"=>$data->id))',
    							'click'=>'function(){
									var th=this;									
									jQuery.ajax({
										type:"POST",
					...
					array(
    					...
    					(
    						...
    						(
            					...
            					'url'=>'Yii::app()->createUrl("admin/entrance/copy", array("id"=>$data->id))',
        					),
        					'view'=>array(
    							'url'=>'$data->url',
    						)
