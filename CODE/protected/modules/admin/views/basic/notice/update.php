	...
	<div class="folder top">
		...
		<div class="folder-header">
			...
			<div class="header-menu">
				<ul>
					<li><a class="header-menu-active new-icon" href=""><span>Chỉnh sửa thông báo <?php echo $model->title;?></span></a></li>					
				</ul>
			</div>
		</div>
		<!--end title-->
		...
		<div>
            	<input type="button" class="button" value="Thêm thông báo" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('admin/notice/create')?>'"/>
                <input type="button" class="button" value="Danh sách thông báo" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('admin/notice')?>'"/>
			...
			<div class="fl">
				<ul>
					...
					<li>
                        	...
                        	<?php echo $form->dropDownList($model,'list_special',Notice::getList_label_specials(),array('style'=>'width:250px','multiple' => 'multiple')); ?>
					...
					<div id="right_row">	
                    	...
                    	<div class="row">
							<li>
								...
								<!-- <input type="button" id="btn-add-product" class="button" value="Chọn" style="width:60px;padding:1px;margin-top:-5px;" onclick="showPopUp();"/>-->
...
<ul>
	<?php 
		Yii::app()->clientScript->registerScript('search-notice-suggest', "
			$('#notice-search').submit(function(){
			$.fn.yiiGridView.update('notice-list', {
				data: $(this).serialize()});
				return false;
			});");
	?>
	 <?php $form=$this->beginWidget('CActiveForm', array('method'=>'get','id'=>'notice-search')); ?>
	 <li>
     	<?php echo $form->labelEx($model,'title'); ?>
       	<?php $this->widget('CAutoComplete', array(
        	            	'model'=>$suggest,
                         	'attribute'=>'title',
							'url'=>array('notice/suggestTitle'),
							'htmlOptions'=>array(
								'style'=>'width:230px;',
								),
						)); ?>								
	...
	<li>
		...
		<?php echo $form->dropDownList($suggest,'catid',$list,array('style'=>'width:200px','name'=>'SuggestNotice[catid]')); ?>
	</li>            
	<li>
	<label>&nbsp;</label> 
	<input type="submit" class="button" value="Lọc thông báo">
	</li>
	<?php $this->endWidget(); ?>	
	<li>
	  <?php 
			$this->widget('iPhoenixGridView', array(
  				...
  				'summaryText'=>'Có {count} thông báo',
  		...
  		function(){  	
			...
			jQuery.ajax({
				...
				success:function(data){
					$('#Notice_list_suggest').val(data);
					hidenPopUp();
				},
				type:'POST',
				url:'<?php echo $this->createUrl('notice/updateSuggest');?>',
				'cache':'false'});
			return false;
		});
</script>