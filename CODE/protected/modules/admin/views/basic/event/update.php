	...
	<div class="folder top">
		...
		<div class="folder-header">
			...
			<div class="header-menu">
				<ul>
					<li><a class="header-menu-active new-icon" href=""><span>Chỉnh sửa sự kiện <?php echo $model->title;?></span></a></li>					
				</ul>
			</div>
		</div>
		<!--end title-->
		...
		<div>
                ...
                <input type="button" class="button" value="Danh sách sự kiện" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('admin/event')?>'"/>
			...
			<div class="fl">
				<ul>
					...
					<li>
                        	...
                        	<?php echo $form->dropDownList($model,'list_special',Event::getList_label_specials(),array('style'=>'width:250px','multiple' => 'multiple')); ?>
...
<ul>
	<?php 
		Yii::app()->clientScript->registerScript('search-event-suggest', "
	...
	<li>
		...
		<?php echo $form->dropDownList($suggest,'catid',$list,array('style'=>'width:200px','name'=>'SuggestEvent[catid]')); ?>
	</li>            
	<li>
	<label>&nbsp;</label> 
	<input type="submit" class="button" value="Lọc sự kiện">
	</li>
	<?php $this->endWidget(); ?>	
	<li>
	  <?php 
  		...
  		function(){  	
			...
			jQuery.ajax({
				...
				success:function(data){
					$('#Event_list_suggest').val(data);
					hidenPopUp();
				},
				type:'POST',
				url:'<?php echo $this->createUrl('event/updateSuggest');?>',
				'cache':'false'});
			return false;
		});
</script>