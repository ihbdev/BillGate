<div class="box">
<?php $this->widget('wBanner',array('code'=>Banner::CODE_PRIMARY_SCHOOL_MIDDLE,'view'=>'school-middle'))?>
</div><!--box-->
<div class="box">
<div class="box-title"><label>TIN BILLGATES PRIMARYSCHOOL</label></div>
