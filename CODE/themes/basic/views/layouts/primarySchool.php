...
<title>Primary School - Home page</title>
<!--css default-->
...
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->theme->baseUrl?>/css/style-prishool.css">
    ...
    <div class="wrapper">
        ...
        <div class="bground">
            <div class="sidebar-left">            	
            		<?php $this->widget('wCategory',array('type'=>Category::TYPE_PRIMARYSCHOOL,'view'=>'menu-left','current_catid'=>$this->current_catid));?>    
                <div class="box-ad-left">
                	<?php $this->widget('wBanner',array('code'=>Banner::CODE_PRIMARY_SCHOOL_LEFT,'view'=>'school-banner-left'))?>                	
                </div><!--box-ad-left-->
            </div><!--sidebar-left-->
            <div class="main">
            	<?php $this->widget('wBanner',array('code'=>Banner::CODE_PRIMARY_SCHOOL_HEADLINE,'view'=>'school-head-line'))?>               
                <?php echo $content?>
            </div><!--main-->
